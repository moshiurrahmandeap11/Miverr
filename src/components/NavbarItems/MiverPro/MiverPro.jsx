...
const MiverPro = () => {
  ...
  return (
    ...
    >
        ...
        {features.map((f, i) => (
          ...
          >
            ...
            <div>
              ...
              <p className="hidden lg:block text-sm text-gray-600 leading-snug">{f.desc}</p>
            </div>
          </div>
        ))}
      </div>
      ...
      {/* Offer Section */}
      <h1 className="hidden lg:block text-lg font-semibold text-indigo-600">Find work on Fiverr Pro</h1>
      <div className="hidden lg:flex items-start gap-5 hover:underline cursor-pointer">
        <img
