  ...
  return (
    <div className="bg-white mx-auto px-4 py-10">
      <div className="max-w-10/12 l mx-auto relative">
        ...
        {/* Custom Arrows */}
        <button
          className="custom-prev absolute top-1/2 -left-6 -translate-y-1/2 z-30 p-3 bg-gray-200 rounded-full hover:bg-gray-300 text-gray-700 shadow-md transition"
          aria-label="Previous"
        >
          &#8592;
        </button>
        <button
          className="custom-next absolute top-1/2 -right-6 -translate-y-1/2 z-30 p-3 bg-gray-200 rounded-full hover:bg-gray-300 text-gray-700 shadow-md transition"
          aria-label="Next"
        >
          &#8594;
        </button>
