...
import SatisfactionMakeSlider from "./SatisfactionMakeSlider/SatisfactionMakeSlider";
...
const SatisfactionMake = () => {
  return (
    <section>
            ...
            const styles =
              i === 0
                ...
                : {
                    ...
                    left: "80%",
                    transform:
                      "translate(-100%, -50%) scale(0.85) rotate(8deg)",
                    opacity: 0.5,
                    zIndex: 4,
                    filter: "brightness(70%)",
                    border: "3px solid rgba(99, 102, 241, 0.4)",
      ...
      <SatisfactionMakeSlider></SatisfactionMakeSlider>
    </section>
  );
};
